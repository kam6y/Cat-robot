...
8Kから上限の32K（実効32,000）までiPhone 16 Proで比較し、現状は8Kを維持しています。容量拡大による回答品質の改善は確認できず、長い履歴や分類との会話切り替えには未解決の問題があります。[比較結果と再実行手順](docs/validation/2026-09-21-gemma-context-tuning.md)を参照してください。
